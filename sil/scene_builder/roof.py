"""박공지붕 + 상부 철골 + H형강 기둥 — 원본 roof_structure.py 본문 이동 (치수 상수는 config, pxr 필요)."""
...
from .config import (CENTER_Z, CHORD0, EAVE_Z, PURLIN_STEP, RIDGE_Y, SHEET_OFF, SLOPE, VENT_HALF,
                     VENT_X0, VENT_X1, X_ROOF0, X_ROOF1, Y_EAVE0, Y_EAVE1)
