...
- `sil/t3_warehouse_map/map/` — **팀원 개편 맵 v5.6(2026-08-28)**: 세로형 랙 11열(기둥 흡수)·스테이션 46·P2G 하이브리드. 검수 반영 4건 — 축선 필터, y≈38.1 상부 구조선 장애물 제외, 기둥 팽창역 간섭 스테이션 이동(남측 작업 라인 y 33.8·handoff W-S 40.8), 자가검증(도달 46/46) 내장. 실행: `map/` 안에서 DXF 심링크와 함께 `python warehouse_layout_v5_5_final.py`
